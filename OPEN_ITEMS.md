...
- **Skin Script RPA production (2026-08-31).** Architecture + 220 Node tests + 12 Python E2E tests on clean branch `codex/skin-script-rpa-task01-closeout`; original PR #8 is already merged from older head `1056dba`, and replacement draft PR #10 carries post-merge RPA session work + Codex TASK-01. TASK-01 remote D1 is complete: `dew-theory-commerce` / `cd55d01f-2c27-4b53-a8aa-9b10555d3b17`, Worker version `30e07650-5d65-4ee1-a4fc-c7f0edf005ae`, production D1 order/job readback passed. Remaining blockers: portal recon, verified mappings, MFA session bootstrap, RPA container host/secrets, real portal dry-run/live validation, and PR #10 merge approval.
