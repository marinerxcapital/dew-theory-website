 ...
 * SKIN_SCRIPT_MODE=mock|http|csv_feed|rpa (default mock)
 */
...
import { createRpaSkinScriptAdapter } from './rpa-adapter.js';
...
export function getSkinScriptAdapter(mode, env = process.env) {
  ...
  if (m === 'rpa') return createRpaSkinScriptAdapter(env);
...
export {
  createMockSkinScriptAdapter,
  createHttpSkinScriptAdapter,
  createCsvFeedSkinScriptAdapter,
  createRpaSkinScriptAdapter
};
