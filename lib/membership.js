...
export const DEFAULT_MEMBERSHIP_PACKAGES = [
  ...
  },
  {
    id: 'home-clinical',
    name: 'Home + clinical',
    description: 'In-studio visits paired with home care guidance — details announced at launch.',
    price_cents: null,
    interval: null,
    perks: ['Facial allotment set with Emily', 'Routine check-ins', 'Shop guidance between visits']
  }
];
