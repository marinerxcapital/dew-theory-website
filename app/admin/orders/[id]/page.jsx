...
export default async function AdminOrderDetailPage({ params }) {
  ...
  return (
    <div>
      <h1 className="font-display text-3xl text-graphite">Order {order.id}</h1>
      ...
      <div className="mt-10 grid gap-12 lg:grid-cols-2">
        <div>
          <h2 className="font-display text-xl text-graphite">Line items</h2>
          ...
          <dl className="mt-6 space-y-2 font-body text-sm font-light text-charcoal/80">
            ...
            <div className="flex justify-between border-t border-chrome/20 pt-2 font-label text-[0.7rem] uppercase tracking-lockup text-graphite">
              <dt>Total</dt>
        ...
        <div className="space-y-8">
          <div>
            <h2 className="font-display text-xl text-graphite">Ship to</h2>
