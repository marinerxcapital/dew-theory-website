...
export default async function AdminHomePage() {
  ...
  return (
    <div>
      <h1 className="font-display text-3xl text-graphite">Overview</h1>
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {cards.map((c) => (
          ...
          >
            ...
            <p className="mt-3 font-display text-2xl text-graphite">{c.value}</p>
          </Link>
        ))}
      </div>
      ...
      <div className="mt-14 grid gap-10 lg:grid-cols-2">
        <div>
          <h2 className="font-display text-xl text-graphite">Recent orders</h2>
        ...
        <div>
          <h2 className="font-display text-xl text-graphite">Audit log</h2>
          <ul className="mt-4 divide-y divide-chrome/20 border-y border-chrome/20">
