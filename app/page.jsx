...
// Real Skin Script catalog data (data/products.json). These three are a starter-routine
// pick, not "top sellers" — there's no sales history yet to rank by.
const products = featured([
  ...
  name: p.name,
  category: p.category,
  price: `$${p.retail_price.toFixed(0)}`,
  note: p.description_short
}));

// PLACEHOLDER — see OPEN_ITEMS.md. Replace with Emily's confirmed menu.
...
export default function Home() {
  return (
    <>
      ...
      {/* Thesis */}
      <section className="border-y border-chrome/15 bg-pearl">
      ...
      {/* Emily — the one band that follows the logo's warm reflection */}
      <section className="border-y border-chrome/15 bg-ivory">
        ...
        >
          {/* Placeholder for Emily's portrait */}
          <div
            data-reveal
